...
<?php
    session_start();
    if(isset($_SESSION['UserID']) && $_SESSION['TypeUser'] === "A" && $_SESSION['StatusUser'] ==="A"){
?>
<head>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <div class="sidebar-card">
                ...
                <p class="text-center mb-2"><strong>RRTur Admin</strong> is packed with premium features, components, and more!</p>
    ...
    <!-- Page level plugins -->
    <script src="../../../vendorTemplate/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="../../../jsTemplate/demo/chart-area-demo.js"></script>
    <script src="../../../jsTemplate/demo/chart-pie-demo.js"></script>
    ...
    BuscaTotalUser = () =>{
        $.ajax({
            ...
            for(let i=0; i <res.length;i++){
                $("#Qtduser").html("");
                $("#Qtduser").append( document.createTextNode(res[i].value))
            }
        })
    }
   setInterval(() => {
